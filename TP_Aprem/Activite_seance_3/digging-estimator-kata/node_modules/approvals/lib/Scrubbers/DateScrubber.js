...
class DataScrubber {
    static getSupportedFormats() {
        return [
            __(/[a-zA-Z]{3} [a-zA-Z]{3} \d{2} \d{2}:\d{2}:\d{2}/g, ["Tue May 13 16:30:00"]),
            __(/[a-zA-Z]{3} [a-zA-Z]{3} \d{2} \d{2}:\d{2}:\d{2} [a-zA-Z]{3,4} \d{4}/g, ["Wed Nov 17 22:28:33 EET 2021"]),
            __(/[a-zA-Z]{3} [a-zA-Z]{3} \d{2} \d{4} \d{2}:\d{2}:\d{2}.\d{3}/g, ["Tue May 13 2014 23:30:00.789"]),
            __(/[a-zA-Z]{3} [a-zA-Z]{3} \d{2} \d{2}:\d{2}:\d{2} -\d{4} \d{4}/g, ["Tue May 13 16:30:00 -0800 2014"]),
